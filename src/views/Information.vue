    ...
    <v-container>
      ...
      <v-row>
        ...
        <v-col cols="8">
          <p>
            ...
            integral part of their daily healing regiment. Now this life
            restoring gift is being share with the world.
          </p>
          <p>
            Our product are NOT formulated with the much cheaper 'Chaga
            Mushroom' that are extremely high in kidney damaging oxalates that
            many companies attempt to pass off as a substitute, marketing under
      ...
      <v-row>
        <v-col>
          <p>
            ...
            beta-d-glucans and germanium, of those found in Chaga. Also, when
            the Shiaqga mushroom is then super concentrated in its bioavailable
            liquid extract form, the therapeutic benefits grow exponentially.
          </p>
          <p>
          ...
          <p>
            Our organic and wild crafted essential oils are also grown,
            harvested, and processed according to the same highest standards
            above and are added to the extract in their pure full potency form,
            again, with no dilution or adulteration to ensure maximum benefits.
          </p>
        </v-col>
      </v-row>
      <v-row>
      ...
      <v-row>
        <v-col>
          ...
          <p>
            Extract of Wild Shiaqga Mushroom (now a 1200% concentrate) and
            Organic Essential Oils of Black Cumin, Lemon, Cinnamon Bark,
            Peppermint, and Wild Sacred Frankincense
          </p>
          <p>
            Suggested Use: 3 dropper squirts a day. (You may want to switch to
            the Shiaqga Super Concentrate if you suffer from a chronic health
            condition.) Direct sublingual or mixed in water according to
            personal preference. Note: The taste is considered mild and very
            pleasant by most - many pets like it as well.
          </p>
        </v-col>
      </v-row>
      <v-row>
        <v-col>
          <h2>
            ...
            ingredients of the original formula but is different in the
            following ways:
          </h2>
          <ul>
            <li>
